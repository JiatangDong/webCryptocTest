...
/*export*/ async function encryptSymmetric256Async(secret: Uint8Array, secretKey: Uint8Array) : Promise<Uint8Array> {
...
/*export*/ async function decryptSymmetric256Async(encryptedMessage: Uint8Array, secretKey: Uint8Array) : Promise<ArrayBuffer> {
    ...
    const signature = (await crypto.subtle.sign('HMAC', macKey, data)).slice(0, tagLength);
